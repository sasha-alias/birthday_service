Vagrant.configure("2") do |config|
  ...
  config.vm.define "nodeB" do |replica|
    ...
    replica.vm.network :forwarded_port, guest: 22, host: 64674, id: "ssh", auto_correct: true
  end


  config.vm.define "node-backend" do |primary|
    primary.vm.network :private_network, ip: "192.168.111.18"
    primary.vm.network :forwarded_port, guest: 22, host: 64675, id: "ssh", auto_correct: true
  end
